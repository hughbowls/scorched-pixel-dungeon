...
public class ScorchedUnlockScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton link = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(this, "unlock_ok")){
			@Override
		...
		link.icon(Icons.get(Icons.BADGES));
	...
	private static class UnlockMessage extends Component {
